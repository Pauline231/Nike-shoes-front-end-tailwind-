...
const Hero = () => {
  ...
  return (
    <>
    <section id='home' className='w-screen flex xl:flex-row flex-col justify-center max-container gap-10 p-2'>
      ...
      <div className='relative flex justify-center items-center max-xl:py-40 bg-hero bg-primary bg-cover bg-center'>
